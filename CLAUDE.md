...
4. **Perguntas 12 a 16** — projeção de futuro, concordância de gasto, acompanhamento,
   compromisso, liberação (a pergunta de concordância sobre alimentação foi removida).
